...
namespace AustinVenues.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public DisciplinesController(VenueDbContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Label")] Discipline discipline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Label")] Discipline discipline)
        {
            if (id != discipline.Id)
            {
                return NotFound();
